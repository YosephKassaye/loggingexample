...
namespace CustomLogging.Logger
{
    public class FileLogger : ILogger
    {
        ...
        public FileLogger(  FileLoggerProvider fileProvider)
        {
        ...
        public void Log<TState>(LogLevel logLevel, EventId eventId, TState state, Exception exception, Func<TState, Exception, string> formatter)
        {
            ...
            Task.Run(async () =>
            {
                ...
                var fullFilePath = _fileProvider.Options.FolderPath + "/" + _fileProvider.Options.FilePath.Replace("{date}", DateTimeOffset.UtcNow.ToString("yyyyMMdd")); // Get the full log file path. Seperated by day.
                ...
                try
                {
                    ...
                    await _fileProvider.WriteFileLock.WaitAsync();
                ...
                finally
                {
                    ...
                    _fileProvider.WriteFileLock.Release();
                }
            });
        }
